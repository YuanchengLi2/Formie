  ...
  return (
    <View testID="recording-review-checklist" style={{ overflow: "hidden", borderRadius: radii.lg, borderCurve: "continuous", borderWidth: 1, borderColor: "#2B2B2B", backgroundColor: "#111111", paddingHorizontal: 14, paddingVertical: 5 }}>
      {RECORDING_CHECKS.map((label, index) => (
        <View key={label} testID={`recording-review-check-row-${index}`} style={{ width: "100%", minHeight: 86, flexDirection: "row", alignItems: "center", gap: 12, paddingVertical: 12, borderBottomWidth: index < RECORDING_CHECKS.length - 1 ? 1 : 0, borderBottomColor: colors.border }}>
