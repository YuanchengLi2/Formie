...
describe("ResultsScreen", () => {
  ...
  it("matches the focused Coaching Review hierarchy and includes every supported improvement point", async () => {
    ...
    expect(screen.getByTestId("movement-score-overall-row").props.style).toEqual(expect.objectContaining({ height: 83 }));
    expect(screen.getByTestId("score-grade-stamp").props.style).toEqual(expect.objectContaining({ width: 80, height: 80, marginLeft: "auto", transform: [{ translateY: -8 }] }));
