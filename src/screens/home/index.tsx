...
function HomeHeader({ onOpenProfile }: { onOpenProfile: () => void }) {
  return (
    <View testID="home-top-bar" style={{ minHeight: 68, flexDirection: "row", alignItems: "center", justifyContent: "space-between" }}>
      ...
      <Pressable accessibilityLabel="Open settings" accessibilityRole="button" onPress={onOpenProfile} style={{ width: 54, height: 54, alignItems: "center", justifyContent: "center", borderRadius: radii.pill, borderWidth: 1, borderColor: colors.gold }}>
