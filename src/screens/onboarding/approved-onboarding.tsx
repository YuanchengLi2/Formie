...
function AccountScreen(props: ApprovedOnboardingScreenProps) {
  ...
  return <AccountAccessScreen mode="onboarding" personalizedMessage={personalizedMessage} busy={props.busy} busyProvider={props.busyProvider} error={props.error} onBack={props.onBack} onOpenTerms={props.onOpenTerms} onOpenPrivacy={props.onOpenPrivacy} onPrivacyConsentChange={(accepted) => props.onAnswerChange("acceptedPrivacy", accepted)} onMarketingOptInChange={(accepted) => props.onAnswerChange("marketingOptIn", accepted)} onApple={() => impactThen(() => props.onOAuth("apple"))} />;
}
...
const styles = StyleSheet.create({
  ...
  productDemonstrationCoachingOverlay: { ...StyleSheet.absoluteFill, width: "100%", height: "100%", opacity: 0.94, transform: [{ scale: 1.07 }] },
  ...
  goldGradientImage: { ...StyleSheet.absoluteFill, width: "100%", height: "100%" },
