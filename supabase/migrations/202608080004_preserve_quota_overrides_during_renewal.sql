-- Keep the latest access function additive: renewal propagation must preserve
-- access without dropping the Test Store quota override and reservation-delta
-- behavior introduced by 202608070004.
