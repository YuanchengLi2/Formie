-- Repair v2 catalog normalization at its source. The original implementation
-- stripped uppercase letters before lowercasing, which made normal title-cased
-- exercise names unsearchable through both the v2 and legacy RPCs.
