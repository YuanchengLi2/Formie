-- v45 accepts only the same short recordings that the capture and upload
-- contracts accept. Completed historical results remain readable; an old
-- result with a longer retained video cannot be queued for a new run.
