-- A provider renewal is asynchronous. During the bounded renewal-pending
-- window, keep the last confirmed paid period usable instead of converting
-- the account to an unknown/inaccessible state while RevenueCat propagates.
