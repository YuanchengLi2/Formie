...
export const BOUNDARY_FREE_ANALYSIS_SCHEMA = {
  ...
  properties: {
    ...
    issues: {
      type: "array",
      description: "Return up to six highest-consequence distinct, evidence-backed form problems visible in the recording. No issue count is required.",
      items: {
        type: "object",
        additionalProperties: false,
