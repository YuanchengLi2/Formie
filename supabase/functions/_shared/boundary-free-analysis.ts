...
Search broadly before answering and return every distinct evidence-backed form issue you find. Do not rank issues into a shortlist, discard a supported issue because another issue seems more important, pad toward a target count, duplicate one problem under multiple labels, invent unsupported faults, or request another video pass.
