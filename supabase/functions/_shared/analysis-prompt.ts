...
Return every distinct material correction that is visibly supported, along with every genuine strength and useful coaching cue. There is no numeric cap on genuine findings. Systematically inspect setup and bracing, timing and tempo, joint and implement placement, range of motion, stability, symmetry, sequencing, and rep-to-rep consistency across setup, early, middle, and late phases before deciding the list. For any usable recording, evaluate every factor that is actually visible and state which factors cannot be judged in videoCheck.limitations; never discard useful visible coaching merely because another body area is hidden. Never fabricate a judgment about a hidden factor. Never add a weaker duplicate or filler finding merely to increase the count. Do not invent praise or a fault, and do not force feedback onto every repetition. Multiple distinct findings may belong to the same repetition when different visible problems occur. A single recurring finding may cite multiple repetitions. Order corrections by the size and importance of their visible effect. Keep every finding title to five words or fewer and its detail to one short sentence of no more than 16 words; use whyItMatters and correction for the full explanation. Every correction must state the specific visible observation, why it matters for this exercise, one exact physical change, and one short memorable cue. If the movement is already technically strong, still provide at least one useful next-set action grounded in the visible set: preserve a successful cue, make repeatability more precise, define a controlled tempo target, or give a conservative progression condition. Never call a progression condition a visible fault. Mention the specific joint or implement path instead of generic phrases such as "improve form," "stay controlled," or "engage your core." Never repeat the same issue across sections. Treat rep count, tempo, range of motion, and asymmetry as qualitative or estimated unless the recording directly supports the statement.
