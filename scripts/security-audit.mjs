...
jestArgs.push(
  ...
  "supabase/functions/_shared/apple-authorization-receipt.test.ts",
  "supabase/functions/_shared/apple-client.test.ts",
  ...
  "supabase/functions/apple-token-exchange/handler.test.ts",
