...
describe("coaching evaluation", () => {
  it("measures recognition, correction agreement, evidence timing, and verifier use", () => {
    const report = evaluateRows([
      {
        ...
        result: {
          ...
          verification: { performed: true, outcome: "confirmed", usage: { promptTokens: 120, outputTokens: 30, thinkingTokens: 10 } },
        },
      },
      {
        id: "squat-miss",
    ...
    expect(report.verifierUsage).toEqual({ promptTokens: 120, outputTokens: 30, thinkingTokens: 10 });
