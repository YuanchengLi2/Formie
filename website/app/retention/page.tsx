...
export default function RetentionPage() {
  return (
    <LegalPage eyebrow="Your data" title="Retention Policy" updated="September 1, 2026">
      ...
      <p>Use Settings &gt; Delete Account in the Formie app and type DELETE. Formie permanently deletes your account after first requesting Sign in with Apple revocation, Gemini file deletion, and RevenueCat customer deletion; temporary processor failures enter an encrypted retry queue. Formie then removes account-owned database data and private storage. You may delete your account even if a subscription remains active. Account deletion does not cancel your Apple subscription.</p>
